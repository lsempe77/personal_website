...
bibtex_2academic <- function(bibfile,
  ...
  mypubs$mainref <- mypubs$mainref %>% tidyr::replace_na(' ') #otherwise it appears "NA" in post

  mypubs$bibtype <-str_replace_all(mypubs$bibtype, c("Misc" = "Presentation"))

  # str_replace_all(mypubs$bibtype, c("PhdThesis" = "Thesis"))

  mypubs$abstract <- mypubs$abstract %>% as.character() %>% tidyr::replace_na('(Abstract not available)') #otherwise it appears "NA" in post
